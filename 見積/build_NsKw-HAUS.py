...
FIX = [
 ("Ａ－１","LGD3110VLB1　ダウンライトφ112","2F:BR-1、BR-2",10200,6),
 ("Ａ－２","LGD3110VLE1　ダウンライトφ112","1F:サニタリー／2F:BR-2、BR-3",9200,5),
 ("Ｂ","XAD1130VKCB1　ダウンライトφ112 集光","1F:多目的室",12500,1),
 ("Ｃ－１","LGDC3104VLE1　センサダウンライトφ112","1F:SCL",26200,1),
 ("Ｃ－２","LGDC1104VLE1　センサダウンライトφ112","1F:WC",23300,1),
 ("Ｄ－１","SLD3033VLB1　グレアレスダウンライトφ83","1F:L、D",22800,5),
 ("Ｄ－２","SLD1030VLB1　グレアレスダウンライトφ83","1F:K",19700,5),
 ("Ｅ","XAD3432VCE1　ユニバーサルダウンライトφ112","1F:L",21300,1),
 ("Ｆ","XAD3412VCB1　ユニバーサルダウンライトφ112","2F:ワードローブ",20000,1),
 ("Ｇ－１","XAD3410VCB1　傾斜用ダウンライトφ112","2F:BR-3",14900,1),
 ("Ｇ－２","XAD3410VCE1　傾斜用ダウンライトφ112","2F:BR-3、パウダールーム",14900,3),
 ("Ｇ－３","XAD3410VCE1　傾斜用ダウンライトφ112","2F:ワードローブ、ブリッジ、WC",14900,7),
 ("Ｈ","SLD1310VLB1　ウォールウォッシャφ83","1F:L",20800,2),
 ("Ｉ","SLB80541LB1　ウォールウォッシャ□90","2F:BR-3",23900,3),
 ("Ｊ","SLD1039VLB1　ピンホールダウンライトφ75","1F:ENT",22200,1),
 ("Ｋ","LRDC3144VLE1　軒下ダウンライト センサ付","外部",26200,1),
 ("Ｌ","LRD3101VLE1　軒下ダウンライトφ112","外部",7800,2),
 ("Ｍ－１","NTN81352　C-slim L=1515","1F:ENT、L、サンルーム、D",46200,5),
 ("Ｍ－２","NTN81332　C-slim L=840","1F:ENT、L、サンルーム、サニタリー",27000,4),
 ("Ｍ－３","NTN81322　C-slim L=503","1F:D",17500,1),
 ("Ｎ","LGBC70069　フットライト センサ付","2F:パウダールーム",22000,1),
 ("Ｏ","SLBJ71000　フットライト センサ付","2F:ブリッジ",14400,2),
 ("Ｐ－１","LGWC51552LE1　軒下シーリング センサ付","地下ガレージ",26000,1),
 ("Ｐ－２","LGW51502LE1　軒下シーリング","地下ガレージ",14400,3),
 ("Ｑ","LGW46153KLE1　表札灯 防雨","外部 門扉",39000,1),
 ("Ｒ","LGWC47001CE1　スポットライト センサ付","外部",45000,2),
 ("Ｓ","LGW40081LE1　スポットライト 地中埋込","外部",35000,6),
 ("Ｔ－１","DSY5236AWE　ライン照明 L=1451","1F:L",56000,4),
 ("Ｔ－２","DSY5233AWE　ライン照明 L=573","1F:L",26000,3),
]
...
for sym,spec,loc,p,n in FIX:
    T+=it(f"照明器具 {sym}",spec,n,"台",sig(p*RATE),f"{loc}／定価{p:,}円×{RATE}")
T+=it("照明器具 取付費","ダウンライト・ライン照明ほか",NFIX,"台",3000,
...
T+=it("消し遅れスイッチ","DF形 トイレ換気用",2,"箇所",SW1+2000,"1F・2F WC。消し遅れタイマ付につき加算")

cat("03 コンセント設備")
T+=it("2口コンセント","2P15A",30,"箇所",CN2P, f"{READ}／複合単価 埋込形コンセントの取付け費 2P15A×1")
T+=it("接地極付コンセント","2P15A",6,"箇所",CNE, f"{READ}／冷蔵庫・洗濯機・ガス乾太ほか")
T+=it("防水コンセント","2P15A 接地極付",4,"箇所",CNE+2500, f"{READ}／防雨カバー加算")
T+=it("エアコン用コンセント","2P15A 接地極付",6,"箇所",CNE,
...
cat("07 配管配線")
T+=it("電灯配線","EM-EEF1.6-2C",350,"m",C16,"回路数と平均こう長からの推定。要確認")
T+=it("コンセント配線","EM-EEF2.0-2C",350,"m",C20,"回路数と平均こう長からの推定。要確認")
T+=it("3路・4路配線","EM-EEF1.6-3C",120,"m",C163,"回路数と平均こう長からの推定。要確認")
...
MAT = T
T+=it("雑材消耗品","",1,"式",sig(MAT*0.03),"上記計の3%")
...
data={"header":{"name":"ＮｓＫｗ－ＨＡＵＳ　新築工事　電気工事","client":"城秀幸建築設計室",
                "honorific":"御中","date":"2026-08-29","staff":"河口","no":"260829"},
