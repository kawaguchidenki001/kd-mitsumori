...
T+=it("200Vコンセント","2P20A 接地極付",N_CN200,"箇所",CNE+3000,"1F:サニタリー 洗濯機・ガス乾太用。図面に200V表記")
...
cat("07 配管配線")
# 配線は「1カ所いくら」（器具・スイッチ・コンセント1箇所あたりの配線一式）で計上する。
# 単価は No.260114（にぎり長次郎岐阜城東通店）の実績単価による。3路・4路は同見積に
# 無いため片切からの積上げ。
