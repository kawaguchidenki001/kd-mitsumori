...
#   F-3 パイプファン壁付 2F:WC／F-4 浴室暖房換気（ユニットバスのオプション）1F:浴室。
#   器具を当方で入れるのは F-2・F-3。配線は4台とも当方。
T+=it("換気配線","",4,"ケ所",3600,"F-1〜F-4。No.260114の実績単価")
...
T+=it("スイッチ配線","換気用",N_SWF,"ケ所",6500,"消し遅れスイッチ・取付共。No.260114の実績単価")
