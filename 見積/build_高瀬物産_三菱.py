...
def kiki(model):
    ...
    note=(f"三菱電機 スリムER 4方向天井カセット形〈i-スクエア〉。{comp}。"
          f"ご指示価格{price:,}円（定価{teika:,}円に対し掛率{price/teika:.3f}）")
    return [
...
JOBS=[
 dict(tag="A", no="260828", rno="V80DX04-001", taxMode="out",
   title="高瀬物産名古屋支店　事務所系統　室内機2台入替工事",
   sets=['PLZX-ERMP224H6'], setti=292090, haikan=202680, sanpai=60000, unpan=20000, sho=60000,
   sn="機器搬入据付106,610／機器撤去35,680／リモコン取外し取付8,750／ワイドパネル20,000×2枚／スライドブロック6,880×2／ユニック車40,000／室外機転倒防止金具8,690／運搬11,140／試運転調整12,300／現場雑費15,160",
 ...
 dict(tag="B", no="260827", rno="V80DX01-001", taxMode="ex",
   ...
   sn="機器搬入据付179,570／機器撤去45,680／リモコン取外し取付8,750×2／ワイドパネル20,000×3枚／スライドブロック6,880×4／ユニック車40,000／室外機転倒防止金具8,690×2／運搬11,140／試運転調整12,300／現場雑費15,160",
